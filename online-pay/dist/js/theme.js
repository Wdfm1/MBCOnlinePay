	...
	var Core = {
		...
		lightbox: function(options) {
			...
			$.extend(true, $.magnificPopup.defaults, {
				...
				image: {
					tError: '<a href="../../js/%url%">The image</a> could not be loaded.' // Error message when image could not be loaded
				},
				ajax: {
					tError: '<a href="../../js/%url%">The content</a> could not be loaded.' // Error message when ajax request failed
				}
			});
