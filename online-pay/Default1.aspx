        ...
        EnableViewState="False"></asp:TextBox>
              &nbsp;&nbsp;
                  <asp:RequiredFieldValidator 
                      ...
                      ErrorMessage="Pay Code is required" ID="RequiredFieldValidator1" 
        runat="server" precondition="error_text" Enabled="False"></asp:RequiredFieldValidator>
		</li>
	</ul>
</div>
...
<div id="wrapper2">
<asp:LinkButton runat="server" ID="lbspanish" ForeColor="Blue" Visible="False">(Haga clic en para la versión en español)</asp:LinkButton>  
