...
<form id="form1" runat="server">
	<div class="hidden-xs headline">Login
	</div>
    <div class="visible-xs headline2">Login</div>
...
<div class="loginBox">
   <asp:Login ID="Login1" runat="server"   
      ...
      <div class="name_password">
        <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">School Code:&nbsp;</asp:Label>
        <asp:TextBox ID="UserName" runat="server" Width="234px" Height="26px"></asp:TextBox><asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" ErrorMessage="User Name is required." ToolTip="User Name is required." ValidationGroup="Login1">User Name is required.</asp:RequiredFieldValidator>
</div>
	<div class="name_password">
		<asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password">Password:&nbsp;</asp:Label>
        <asp:TextBox ID="Password" runat="server"  
               TextMode="Password" Width="235px" Height="26px"></asp:TextBox><asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password" ErrorMessage="Password is required." ToolTip="Password is required." ValidationGroup="Login1">Password is required.</asp:RequiredFieldValidator>
	</div>
<div class="formCont redtext">
