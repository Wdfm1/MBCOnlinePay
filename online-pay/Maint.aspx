<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Maint.aspx.vb" Inherits="Maint" %>
...
<form id="form1" runat="server">
	<div class="hidden-xs headline">Sorry, we're briefly off-line</div>
    <div class="visible-xs headline2">Sorry, we're briefly off-line</div>

<div style="clear:left"></div>
<div class="formContHolder">
<div class="formDivs" style="padding-bottom:5em">
   <asp:Label ID="lblerror" runat="server" Font-Size="Large" 
        Text="This site is temporarily unavailable because of routine maintenace. We apologize for any inconvenience. Please try again at a later time." 
