...
<form id="form1" runat="server">
	<div class="hidden-xs headline">
	  <asp:Label ID="lblpaytype" runat="server" >Parent Payment Page</asp:Label>
	</div>
    <div class="visible-xs headline2">Parent Payment Page
	</div>
<div class="formDivs">
   <a href="http://www.memorybook.com/online-pay/Default.aspx">Parents should enter your code in the textbox below and click next to proceed. If you are a school, please visit the school page </a><br />
    <br />
...
<!-- (c) 2005, 2013. Authorize.Net is a registered trademark of CyberSource Corporation -->
        ...
        runat="server" precondition="error_text"></asp:RequiredFieldValidator>
				...
				ErrorMessage="You are on Parent Pay. Requires a 5 digit code." 
